...
public interface LightBlubI extends DeviceI
{
    void setColor(Colors color, com.zeroc.Ice.Current current)
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_setColor(LightBlubI obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        Colors iceP_color;
        iceP_color = Colors.ice_read(istr);
        inS.endReadParams();
